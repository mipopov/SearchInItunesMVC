...
public struct ITunesApp: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.versionUpdate = (try? container.decode(String.self, forKey: .versionUpdate))
    }
    ...
    internal init(appName: String,
                  ...
                  size: Bytes?,
                  iconUrl: String?,
                  screenshotUrls: [String], releaseNotes: String, releaseDate: String, version: String) {
